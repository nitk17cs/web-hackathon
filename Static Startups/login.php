	...
	<button onclick="location.href='index.html'" class="btn"><i class="fa fa-home"></i></button>
		<div class="container">
			<ul class="nav navbar-nav">
				<li class="heading" style="margin-left: -140px;"><img src="assets/img/portfolio/nk.jpg" width="100px" />&nbsp;<strong>Static Startups</strong> <i class="fa fa-plus-circle" aria-hidden="true"></i></li>
